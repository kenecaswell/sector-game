...
// (client/src/game/hex.ts adds the projection helpers) — the simulation never
// sees it. The server adds its structure collision code in server/src/hex.ts.
// Both of those re-export this file, so import from them as usual.
//
...
export const STRUCTURE_ROTATION = 0; // flat top, like the tiles
